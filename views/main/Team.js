...
export const TeamMember = ({ role }) => {
    return (
        <>
            <div className="p-16 rounded-md shadow-lg flex flex-col justify-center items-center gap-2">
                <div className="p-24 rounded-full bg-slate-200"></div>
