...
const Nav = () => {
    ...
    return ( 
        <>
            <div className={`flex items-center bg-white justify-between transition-all fixed w-full px-10 pb-4 top-0 z-50 ${navPos === "top" ? "border-0 pt-8" : "border-b pt-6"}`}>
                <Link href="/">
                ...
                <motion.div 
                    ...
                    className="md:hidden fixed bg-main font-sans w-full h-screen top-0 right-0 mt-14 pl-10"
                >
